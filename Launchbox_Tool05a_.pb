...
; Version 0.4a
;
; Changed To HTTP download
; Added genre data to xml
;
; ====================================================================
;
; Version 0.5a
;
; Genre data now saved
;
; ====================================================================
;- ### Enumerations ###
...
Global HTTP_Server.s="https://ftp2.grandis.nu"
...
Procedure Get_Database()
  ...
  DeleteFile(UM_Data_File)
  
  ReceiveHTTPFile("https://ftp2.grandis.nu/turran/FTP/Non%20Amiga/Tools%20for%20Amiga/IG_Tool/IG_Data.dat",Home_Path+"IG_Data.dat")
  
  If FileSize(UM_Data_File)=-1 : MessageRequester("Error","No database file found",#PB_MessageRequester_Error|#PB_MessageRequester_Ok) : EndIf
...
Procedure Fix_List()
  ...
  ForEach UM_Database()
    ...
    If FindMapElement(Comp_Map(),LCase(UM_Database()\UM_Archive))
      ...
      UM_Database()\Genre=Comp_Database()\C_Genre
    EndIf
...
; Compiler = PureBasic 6.21 Beta 6 - C Backend (Windows - x64)
; Debugger = Standalone
; IncludeVersionInfo
; VersionField0 = 0,0,0,5
; VersionField1 = 0,0,0,5
; VersionField2 = MrV2K
; VersionField3 = Launchbox Tool
; VersionField4 = 0.5 Alpha
; VersionField5 = 0.5 Alpha
; VersionField6 = Launchbox XML Conversion Tool
; VersionField7 = Launchbox_Tool
; VersionField8 = Launchbox_Tool.exe
; VersionField9 = 2025 Paul Vince
; VersionField10 = -
; VersionField11 = -
; VersionField12 = -
; VersionField13 = -
